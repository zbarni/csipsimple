...
public class DBProvider extends ContentProvider {
    ...
    private static final int COMPONENT_SUBSCRIPTIONS = 13, COMPONENT_SUBSCRIPTIONS_ID=14,
    		COMPONENT_SUBSCRIPTIONS_GROUP=15;
    ...
    static {
        ...
        URI_MATCHER.addURI(SipManager.AUTHORITY, ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME, COMPONENT_SUBSCRIPTIONS);
        URI_MATCHER.addURI(SipManager.AUTHORITY, ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME + "/#", COMPONENT_SUBSCRIPTIONS_ID);
        URI_MATCHER.addURI(SipManager.AUTHORITY, ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME +"/group", COMPONENT_SUBSCRIPTIONS_GROUP);
	...
	public final static String[] ACCOUNT_FULL_PROJECTION = {
		...
		SipProfile.FIELD_IPV6_MEDIA_USE, SipProfile.FIELD_GRUU
	};
    ...
    public static final String[] COMPONENT_SUBSCRIPTIONS_FULL_PROJECTION = new String[] {
    	ComponentSubscription.FIELD_ID,
		ComponentSubscription.FIELD_ACC_ID,
		ComponentSubscription.FIELD_BUDDY_ID,
	...
	public String getType(Uri uri) {
		switch (URI_MATCHER.match(uri)) {
            ...
            case THREADS_ID:
                return SipMessage.MESSAGE_CONTENT_ITEM_TYPE;
            case COMPONENT_SUBSCRIPTIONS:
                return ComponentSubscription.COMPONENT_SUBSCRIPTIONS_CONTENT_TYPE;
            case COMPONENT_SUBSCRIPTIONS_GROUP:
                return ComponentSubscription.COMPONENT_SUBSCRIPTIONS_CONTENT_TYPE;
            case COMPONENT_SUBSCRIPTIONS_ID:
                return ComponentSubscription.COMPONENT_SUBSCRIPTIONS_ITEM_TYPE;
            default:
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
        ...
        switch (matched) {
            ...
            case MESSAGES_ID:
                ...
                break;
            case COMPONENT_SUBSCRIPTIONS:
                count = db.delete(ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME, where, whereArgs);
                break;
            case COMPONENT_SUBSCRIPTIONS_ID:
                finalWhere = DatabaseUtilsCompat.concatenateWhere(ComponentSubscription.FIELD_ID + " = " + ContentUris.parseId(uri), where);
                count = db.delete(ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME, finalWhere, whereArgs);
                break;
            case THREADS_ID:
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
		...
		case COMPONENT_SUBSCRIPTIONS:
		case COMPONENT_SUBSCRIPTIONS_ID:
		    matchedTable = ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME;
            baseInsertedUri = ComponentSubscription.COMPONENT_SUBSCRIPTION_ID_URI_BASE;
		    break;
		case ACCOUNTS_STATUS_ID:
			long id = ContentUris.parseId(uri);
			synchronized (profilesStatus){
...
//        	if (s!=null) {
//        		Log.d(THIS_FILE, "@zdb possible: " + s);
//        	}
//        }
        
//   		Log.d(THIS_FILE, "@zdb selection is before q: " + selection);
        ...
        switch (type) {
            ...
            case MESSAGES_ID:
                ...
                break;
            case COMPONENT_SUBSCRIPTIONS:
            	Log.d(THIS_FILE, "@zdb Querying COMPONENT_SUBSCRIPTIONS");
                qb.setTables(ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME);
                if(sortOrder == null) {
                    finalSortOrder = ComponentSubscription.FIELD_ACC_ID + " DESC";
                }
                break;
            case COMPONENT_SUBSCRIPTIONS_GROUP:
            	Log.d(THIS_FILE, "@zdb Querying COMPONENT_SUBSCRIPTIONS_GROUP");
                qb.setTables(ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME);
                if(sortOrder == null) {
                    finalSortOrder = ComponentSubscription.FIELD_ACC_ID + " DESC";
                    finalGrouping = ComponentSubscription.FIELD_BUDDY_ID;
                }
                break;
            case COMPONENT_SUBSCRIPTIONS_ID:
            	Log.d(THIS_FILE, "@zdb Querying COMPONENT_SUBSCRIPTIONS_ID");
                qb.setTables(ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME);
                qb.appendWhere(ComponentSubscription.FIELD_ID + "=?");
                finalSelectionArgs = DatabaseUtilsCompat.appendSelectionArgs(selectionArgs, new String[] { uri.getLastPathSegment() });
                break;    
            case THREADS:
                qb.setTables(SipMessage.MESSAGES_TABLE_NAME);
	...
	public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        ...
        switch (matched) {
            ...
            case MESSAGES_ID:
                ...
                break;
            case COMPONENT_SUBSCRIPTIONS:
            	Log.d(THIS_FILE,"@zsub updating subscriptions");
                count = db.update(ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME, values, where, whereArgs);
                break;
            case COMPONENT_SUBSCRIPTIONS_ID:
            	Log.d(THIS_FILE,"@zsub updating subsc ID ID ID");
            	finalWhere = DatabaseUtilsCompat.concatenateWhere(ComponentSubscription.FIELD_ID + " = " + ContentUris.parseId(uri), where);
                count = db.update(ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME, values, finalWhere, whereArgs);
                break;
            case ACCOUNTS_STATUS_ID:
    			long id = ContentUris.parseId(uri);
    			synchronized (profilesStatus){
	...
	private static List<String> getPossibleFieldsForType(int type){
        ...
        switch (type) {
            ...
            case COMPONENT_SUBSCRIPTIONS_ID:
            case COMPONENT_SUBSCRIPTIONS_GROUP:
                possibles = Arrays.asList(COMPONENT_SUBSCRIPTIONS_FULL_PROJECTION);
                break;
            case THREADS:
            case THREADS_ID:
