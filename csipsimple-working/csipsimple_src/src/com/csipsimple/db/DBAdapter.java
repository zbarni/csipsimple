...
public class DBAdapter {
	...
	public static class DatabaseHelper extends SQLiteOpenHelper {
		...
		private final static String TABLE_COMPONENT_SUBSCRIPTIONS_CREATE = "CREATE TABLE IF NOT EXISTS "
				+ ComponentSubscription.COMPONENT_SUBSCRIPTIONS_TABLE_NAME
				+ " ("
					+ ComponentSubscription.FIELD_ID			+ " INTEGER PRIMARY KEY AUTOINCREMENT,"
					+ ComponentSubscription.FIELD_ACC_ID		+ " INTEGER,"
					+ ComponentSubscription.FIELD_BUDDY_ID		+ " INTEGER,"
					+ ComponentSubscription.FIELD_BUDDY_URI		+ " TEXT,"
					+ ComponentSubscription.FIELD_COMPONENT_ID	+ " TEXT,"
					+ ComponentSubscription.FIELD_COMPONENT_NAME+ " TEXT,"
					+ ComponentSubscription.FIELD_STATUS		+ " INTEGER"
				+");";
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL(TABLE_COMPONENT_SUBSCRIPTIONS_CREATE);
		}
