...
//    //@zajzi
    public void on_buddy_component_state(int buddyId, pj_str_t componentId, pj_str_t state) {
    	String cId = PjSipService.pjStrToString(componentId);
    	String s = PjSipService.pjStrToString(state);
    	pjService.service.cService.getSubscriptionManager().onSubscriptionStateChange(buddyId, cId, s);
    }
    
    
    public void on_incoming_subscribe_component(int accId, pj_str_t componentId, pj_str_t fromUri) {
    	Log.d(THIS_FILE,"@zbuddy Incoming SUBSCRIBE request");
    	String cId = PjSipService.pjStrToString(componentId);
    	String s = PjSipService.pjStrToString(fromUri);
    	pjService.service.cService.getSubscriptionManager().onIncomingSubscription(accId, cId, s);
    }
    /*
