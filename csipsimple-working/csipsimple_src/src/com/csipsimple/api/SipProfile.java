...
public class SipProfile implements Parcelable {
    ...
    public static final String FIELD_GRUU = "gruu";
    ...
    private SipProfile(Parcel in) {
        ...
        gruu = getReadParcelableString(in.readString());
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(getWriteParcelableString(gruu));
    }
    ...
    private final void createFromContentValue(ContentValues args) {
        ...
        tmp_s = args.getAsString(FIELD_GRUU);
        if (tmp_s != null) {
            gruu = tmp_s;
        }
    }
