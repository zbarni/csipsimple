...
public class SipProfileState implements Parcelable, Serializable{
	...
	public final static String GRUU = "gruu";

	public static final String [] FULL_PROJECTION = new String[] {
		ACCOUNT_ID, PJSUA_ID, WIZARD, ACTIVE, STATUS_CODE, STATUS_TEXT, EXPIRES, DISPLAY_NAME, PRIORITY, REG_URI, GRUU
	};
