...
interface ISipService{
	...
	String getComponentName (int value);
	String getComponentId (int value);
	void onSubscriptionUpdate(int accId, int buddyId);
	int addBuddyForOutgoingSubscription(int accId,String buddyUri);
	void removeBuddyForOutgoingSubscription(int accId,String buddyUri);
	//***
	/**
