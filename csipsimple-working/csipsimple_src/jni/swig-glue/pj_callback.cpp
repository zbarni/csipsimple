...
void on_incoming_subscribe_component_wrapper(
		pjsua_acc_id acc_id, pj_str_t component_id, pj_str_t from_uri) {
	registeredCallbackObject->on_incoming_subscribe_component(acc_id,component_id,from_uri);
}

void on_buddy_component_state_wrapper(pjsua_acc_id acc_id, pj_str_t component_id, pj_str_t state) {
	registeredCallbackObject->on_buddy_component_state(acc_id, component_id, state);
}
...
struct pjsua_callback wrapper_callback_struct = {
	...
	&on_buddy_component_state_wrapper, // @zajzi
