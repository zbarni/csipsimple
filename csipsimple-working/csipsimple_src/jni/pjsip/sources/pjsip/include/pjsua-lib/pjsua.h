...
typedef struct pjsua_callback
{
    ...
    /**
    * @zajzi When subscription to component changes
    */
    void (*on_buddy_component_state)(pjsua_buddy_id buddy_id,
    		pj_str_t component_id,
    		pj_str_t state);
...
PJ_DECL(pj_status_t) pjsua_add_component_subscription(pj_str_t comp_name,
							pjsua_buddy_id buddy_id);
PJ_DECL(void) pjsua_remove_component_subscription(pj_str_t comp_name,
							pjsua_buddy_id buddy_id);
/**
